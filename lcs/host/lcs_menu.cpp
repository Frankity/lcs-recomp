...
Option g_options[] = {
    ...
    {"FEX_BLM", "BLOOM", static_cast<std::uint32_t>(kBloomModes.size()),
     ...
     0u, 0u, nullptr, 1u},
    {"FEX_HDR", "HDR", static_cast<std::uint32_t>(kFxaaChoices.size()), nullptr, nullptr, nullptr,
     0u, 0u, nullptr, 1u, kFxaaChoices.data(), "Rendering", "HDR",
     [](const Config &c) { return c.rendering.hdr ? 1.0f : 0.0f; }, nullptr},
    {"FEX_A2C", "ALPHA COVERAGE", static_cast<std::uint32_t>(kFxaaChoices.size()), nullptr, nullptr, nullptr,
     0u, 0u, nullptr, 1u, kFxaaChoices.data(), "Rendering", "AlphaToCoverage",
     [](const Config &c) { return c.rendering.alpha_to_coverage ? 1.0f : 0.0f; }, nullptr},
